      ...
      <div className="container my-5">
        ...
        >
          <motion.h2 
            ...
            style={{ color: '#d97706', fontSize: '2.5rem', fontWeight: 800 }}
          >
                ...
                >
                  <div className="card glass text-center p-4 h-100">
                    <motion.div
                      ...
                      transition={{ duration: 0.5 }}
                    >
                      <Icon size={60} style={{ color: '#fbbf24', marginBottom: '1rem' }} />
                    </motion.div>
                    <h4 style={{ color: '#fbbf24', marginBottom: '1rem' }}>{feature.title}</h4>
        ...
        <motion.section
          ...
          transition={{ duration: 0.6 }}
        >
          <h2 className="mb-4" style={{ color: '#d97706', fontSize: '2.5rem', fontWeight: 800 }}>
            Trạng Thái Server
          </h2>
          {serverStatus && (
                  ...
                  <div>
                    <motion.span 
                      ...
                      style={{ 
                        fontSize: '1rem', 
                        padding: '0.5rem 1rem',
                        background: serverStatus.status === 'Online' ? '#dc2626' : '#f97316',
                        color: '#ffffff',
                        fontWeight: 700
                      }}
                    >
